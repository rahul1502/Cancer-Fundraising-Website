...
@media (max-width:320px){                                  
                            ...
                            if (email.value == "/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/")
    {
        ...
        return false;
		        ...
		        if(email == "Email" ||  pass == "Password" || email.length == 0 || pass.length == 0 ){
		        	alert("email or password can not be empty.");
		        	return false;
		        }
		        else if(pass.length < 6){
		        	alert("password must be of atleast length 6");
		        	return false;
		        }
		        else{
		        	return true;
    ...
    <div class="navbar navbar-inverse navbar-fixed-top move-me" id="menu" >
	 ...
	 <div class="main">
		<div class="login-form">   
				...
				<form name="loginform"  action="login" onsubmit="return validateEmail()" method="post" >
						<input type="text"     name="email" value="Email" class="text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" >
