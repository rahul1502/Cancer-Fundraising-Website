<%-- 
    Document   : donor
    Created on : Mar 16, 2016, 12:29:05 AM
    Author     : ghost
--%>
...
@media (max-width:320px){                                  
	...
	<div class="navbar navbar-inverse navbar-fixed-top move-me" id="menu" >
		...
		<div class="login-form">
			<h1>Enter your Details</h1>
				<form name="details" method="post" action="fundDistribution" >
						<input type="text"     name="amount" value="Amount of money you wanna donate" class="text"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Amount of money you wanna donate';}" >
                                                </br></br></br></br>
						<input type="text" name="fname"  value="First Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'First Name';}"></br>
						<input type="text" name="lname"  value="Last Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Last Name';}"></br>
                                                <input type="text" name="email"  value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}"></br>
                                                <input type="text" name="mobileno"  value="Mobile Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile Number';}"></br>
                                                <input type="text" name="address"  value="Address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Address';}"></br>
                                                <input type="text" name="city"  value="City" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'City';}"></br>
                                                <input type="text" name="zipcode"  value="Zip Code" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Zip Code';}"></br>
		...
		<ul id="checkout">
			<li>
				...
				<div>
					<div>
						...
						<select id="bank">
							<option value="CID001">Bank of India</option>
							<option value="CID002">State Bank of India</option>
                                                        <option value="CID003">Punjab national bank</option>
                                                        <option value="CID004">Standard Chartered Bank</option>
                                                        <option value="CID005">Axis bank</option>
                                                        <option value="CID006">Swiss bank</option>
						</select>
					</div>	
				</div>
			</li>
			...
			<li>
				<input type="radio" name="paymentMode" id="prepaid" />
				<label for="prepaid">Paytm</label>
				<div>
					<div>
						<label for="prepaidCardHolder">Phone Number</label>
						<input type="text" id="prepaidCardHolder"/>
					</div>
	...
	<script type="text/javascript" src="../../lib/citrus.js"></script>
