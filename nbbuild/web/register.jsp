    ...
    <div class="navbar navbar-inverse navbar-fixed-top move-me" id="menu" >
	 ...
	 <div class="main">
		...
		<div class="login-form">
			<h1>Register here to start a new fundraiser.</h1>
					<div class="head">
						<img src="user.png" alt=""/>
					</div>
				<form name="registerform"  action="register" onsubmit="return validateForm()" method="post" >
                                    <div class="lable">
                                    <div class="col_1_of_2 span_1_of_2">	<input type="text" class="text" name="first_name" value="First Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'First Name';}" ></div>
                                    <div class="col_1_of_2 span_1_of_2"><input type="text" class="text" name="last_name" value="Last Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Last Name';}"></div>
                                    <div class="clear"> </div>
                                    </div>
                                    <div class="lable-2">
                                    <input type="text"  name="email" value="your@email.com " class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'your@email.com ';}">
                 
                                  <input type="text"  name="contact_number" value="Contact Number"  class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contact Number ';}">
                                    <input type="password"  name="password" value="Password " class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password ';}">
                                 <input type="password"  name="repassword" value="Password " class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password ';}">
<!--name???  -->                    <input type="radio" name="gender" value="Male" class="radio" >Male    &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp		
                                    <input type="radio" name="gender" value="Female" checked class="radio" >Female
                                    <input type="text"  name="age" value="Age" class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Age ';}">
                                    <input type="text"  name="address" value="Address" class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Address ';}">
                                    <input type="text"  name="cancer_type" value="Cancer type" class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Cancer type ';}">
                           
                                    <input type="text"  name="stage" value="Stage" class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Stage ';}">
                                   <input type="text"  name="Money_needed" value="Money needed" class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Money needed';}">
				
				
                                    </div>
                                    <h3>By creating an account, you agree to our <span class="term"><a href="termsandcond.jsp">Terms & Conditions</a></span></h3>
                                    <div class="submit">
                                        <input type="submit" value="Start Fundraiser"  >
                                    </div>
