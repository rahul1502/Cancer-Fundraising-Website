<%-- 
    ...
    Created on : Mar 16, 2016, 3:49:11 AM
    Author     : ghost
--%>
    ...
    <body bgcolor="#3b945f">
		...
		<div class="login-form">
			<h1>Welcome <%=request.getAttribute("fname") %> <%=request.getAttribute("lname")%></h1>
				...
				<form name="loginform" >
				    Email : <%=request.getAttribute("e") %></br></br>
                                   
                                    Contact Number : <%=request.getAttribute("cno") %></br></br>
                                    Gender : <%=request.getAttribute("g") %></br></br>
                                    Age : <%=request.getAttribute("age") %></br></br>
                                    Address : <%=request.getAttribute("add") %></br></br>
                                    Cancer Type : <%=request.getAttribute("type") %></br></br>
                                    Cancer Stage : <%=request.getAttribute("stg") %></br></br>
                                    
                                    </br></br></br>
                                    Fund Needed : <%=request.getAttribute("amtn") %></br>
                                    Fund Raised : <%=request.getAttribute("fnd") %>
